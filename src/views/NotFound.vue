<template>
  <section class="text-gray-600 body-font">
    <div class="container mx-auto flex pb-4 items-center justify-center flex-col">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 32 32"
        class="w-3/5 h-3/5 lg:w-2/5"
      >
        <linearGradient
          id="a"
          x1="2.625"
      ...
      <div class="text-center lg:w-2/3 w-full">
        <h1 class="title-font dark:text-gray-100 sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
          File not found
        </h1>
