...
export const socket_io_serverUrl = 'https://open-data.herokuapp.com/';
...
export const weatherApiBaseUrl = 'https://open-data.herokuapp.com/rest-api/v1/weather/';
export const get_currency_api_endpoint = 'https://open-data.herokuapp.com/rest-api/v1/currency';
export const note_api_endpoint = 'https://open-data.herokuapp.com/rest-api/v1/notes';
